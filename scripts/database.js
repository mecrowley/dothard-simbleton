...
export const getNYBusinesses = () => {
    const filteredBusinesses = businesses.filter(businessObject => {
...
export const getAgents = () => {
    ...
    businesses.forEach((business) => {
        ...
        newAgentObject.fullName = `${businessAgent.nameFirst} ${businessAgent.nameLast}`
        newAgentObject.company = `${business.companyName}`
        newAgentObject.phoneNumber = `${business.phoneWork}`
        newAgentArray.push(newAgentObject)
    })
